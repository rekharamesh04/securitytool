...
export default function DataSourceLayout({
  ...
  const tabs = [
    { label: "Overview", route: "/admin/company/data-source/dataDetails/overview" },
    { label: "Issues", route: "/admin/company/data-source/dataDetails/issues" },
    { label: "Classified Data", route: "/admin/company/data-source/dataDetails/classifiedData" },
  ];
  ...
  useEffect(() => {
    ...
    if (currentTabIndex === -1 && pathname?.startsWith("/admin/company/data-source/dataDetails")) {
